// use this file for a forge install, and make sure to have the forge install at /forge so the path looks something like ~/server/forge/run.sh
// start it with screen node forge.js
// then do ctrl + a, d
...
bot.on('ready', client => {
    ...
    minecraftServerProcess = spawn('bash',['run.sh'], {cwd: "./forge"});
